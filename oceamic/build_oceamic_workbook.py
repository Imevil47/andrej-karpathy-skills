...
LISTS = [
    ("F", "PRODUIT / ESPECE", "L_PRODUIT",
     ["SARDINE", "MAQUEREAU", "ANCHOIS", "CHINCHARD", "POULPE", "CALAMAR",
      "CREVETTE", "THON"]),
    ("H", "FOURNISSEUR / PRODUCTEUR", "L_FOURN",
     ["ATLAS PECHE SARL", "SOCIETE MARSA", "PECHE SUD", "COMPTOIR ATLANTIQUE"]),
    ("J", "ORIGINE", "L_ORIGINE",
     ["AGADIR", "LAAYOUNE", "DAKHLA", "TAN-TAN", "SAFI", "ESSAOUIRA"]),
    ("L", "ETAT MATIERE", "L_ETAT",
     ["ENTIER", "HG", "HGT", "FILET", "LONGE", "DECOUPE", "DECHET"]),
    ("N", "CONSERVATION", "L_CONSERV",
     ["FRAIS", "CONGELE", "SAUMURE", "GLACE", "SEC"]),
    ("P", "QUALITE", "L_QUALITE", ["A", "B", "C", "REFUSE"]),
    ("R", "MOULE", "L_MOULE", ["01", "02", "03", "04", "05", "06"]),
    ("T", "SOUS-TRAITANT", "L_STRAIT",
     ["STE FILETAGE ATLANTIC", "CONSERVERIE DU SUD", "ATELIER OUED"]),
    ("V", "DECISION QUALITE", "L_DECISION",
     ["ACCEPTE", "ACCEPTE SOUS RESERVE", "A RECONTROLER", "REFUSE", "BLOQUE"]),
    ...
    ("Z", "TYPE DE CONTROLE", "L_TYPECTRL",
     ["RECEPTION", "STOCK", "SOUS-TRAITANCE", "EXPEDITION"]),
]

EMPLACEMENTS = [
    ("OCEAMIC 2", "INTERNE", "Usine OCEAMIC"),
...
def build_param(wb):
    ...
    reglages = [
        ...
        ("SEUIL HISTAMINE (mg/kg)", 100, "P_HIST",
...
ST_COLS = [
    ...
    ("I", "MOULE ENTREE", "in"), ("J", "HISTAMINE ENTREE", "in"),
...
RES_COLS = [
    ...
    ("I", "HISTAMINE", "in"), ("J", "EMPL. DESTINATION", "in"),
...
QC_COLS = [
    ...
    ("F", "TEMPERATURE (C)", "in"), ("G", "HISTAMINE (MG/KG)", "in"),
...
def build_qualite(wb):
    ...
    fill_col(ws, "R", r0, r1,
             ...
             '"HISTAMINE "&TEXT($G{r},"#,##0")&" mg/kg > seuil "'
             '&TEXT(P_HIST,"#,##0")&". ","")'
...
DEMO = {
    "LOTS": [
        ["255", "SARDINE", "ATLAS PECHE SARL", "AGADIR", "12345-A-6",
         "ENTIER", "CONGELE", "A", "03", D(2026, 8, 3), None,
         "Lot de reference - scenarios 1, 5, 8, 11, 12, 14, 15"],
        ["256", "MAQUEREAU", "SOCIETE MARSA", "LAAYOUNE", "22876-B-1",
         "ENTIER", "CONGELE", "B", "04", D(2026, 8, 4), None,
         "Scenarios 2 et 4 - stock externe puis transfert"],
        ["257", "SARDINE", "ATLAS PECHE SARL", "AGADIR", "33111-C-2",
         "ENTIER", "FRAIS", "A", "02", D(2026, 8, 5), None,
         "Scenario 3 - consommation partielle"],
        ["258", "SARDINE", "ATLAS PECHE SARL", "AGADIR", "44900-E-7",
         "ENTIER", "CONGELE", "B", "03", D(2026, 8, 6), None,
         "Scenario 13 - tentative de sortie superieure au stock"],
        ["300", "ANCHOIS", "PECHE SUD", "DAKHLA", "44222-D-3", "ENTIER",
         "SAUMURE", "A", "02", D(2026, 8, 7), None,
         "Scenario 6 - livraison directe fournisseur vers sous-traitant"],
        ["301", "MAQUEREAU", "SOCIETE MARSA", "LAAYOUNE", "55333-F-8",
         "ENTIER", "CONGELE", "A", "04", D(2026, 8, 10), None,
         "Scenario 7 - sous-traitance EN COURS"],
        ["255-HG", None, None, None, None, "HG", "CONGELE", "A", "03",
         D(2026, 8, 14), "255",
         "Issu de ST-001 - identite heritee du lot 255"],
        ["255-HGT", None, None, None, None, "HGT", "CONGELE", "B", "04",
         D(2026, 8, 14), "255",
         "Issu de ST-001 - envoye en stock externe COFRIGOP"],
        ["300-FIL", None, None, None, None, "FILET", "SAUMURE", "A", "02",
