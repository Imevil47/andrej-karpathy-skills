...
const LABELS: Readonly<Record<string, string>> = {
  ...
  EN_ATTENTE_PRODUCTION: 'En attente de production',
  INACTIF: 'Inactif',
  CONVOYEUR: 'Convoyeur',
  POMPE: 'Pompe',
  ...
  BALANCE: 'Balance',
  DETECTEUR: 'Détecteur',
  MACHINE_TRAITEMENT: 'Machine de traitement',
  DECLAREE: 'Déclarée',
  ...
  SORTIE_INTERVENTION: 'Sortie intervention',
  FAILURE_REPORT: 'Panne',
  MAINTENANCE_WORK_ORDER: 'Ordre de travail',
  ...
  CASSE_MECANIQUE: 'Casse mécanique',
  DEFAUT_CAPTEUR: 'Défaut capteur',
  AUTRE_MODE: 'Autre',
  USURE_NORMALE: 'Usure normale',
  MANQUE_ENTRETIEN: "Manque d'entretien",
  MAUVAISE_UTILISATION: 'Mauvaise utilisation',
  DEFAUT_PIECE: 'Défaut de pièce',
  CORPS_ETRANGER_CAUSE: 'Corps étranger',
  CAUSE_NON_DETERMINEE: 'Cause non déterminée',
  AUTRE_CAUSE: 'Autre',
  // Phase 8: ingredients, consumables, oil tracking, consumption, recovery
  ALIMENTATION_CUVE: 'Alimentation cuve',
  RECUPERATION: 'Récupération',
  REUTILISATION: 'Réutilisation',
  DISPONIBLE: 'Disponible',
  UTILISE_PARTIELLEMENT: 'Utilisée partiellement',
  EXPIRE: 'Expirée',
  ELIMINE: 'Éliminée',
  L: 'L',
  G: 'g',
  ...
  RESTE_NON_REUTILISABLE: 'Reste non réutilisable',
  EXPIRATION: 'Expiration',
  DEFAUT_PRODUIT: 'Défaut produit',
  AUGMENTATION: 'Augmentation',
  DIMINUTION: 'Diminution',
  STANDARD_NON_DEFINI: 'Standard non défini',
