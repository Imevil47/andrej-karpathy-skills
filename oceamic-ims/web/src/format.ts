...
const LABELS: Readonly<Record<string, string>> = {
  ...
  // Phase 6: QMS - non-conformities, CAPA, complaints, audits, documents, recall
  RESPONSABLE_QUALITE: 'Responsable qualité',
  AUDITEUR: 'Auditeur',
  EN_VERIFICATION: 'En vérification',
  EN_ATTENTE: 'En attente',
  RAW_MATERIAL_LOT: 'Lot matière première',
  PRODUCTION_RUN: 'Run de production',
  FILLING_OPERATION: 'Opération de remplissage',
  FILLING_WEIGHT_CONTROL: 'Contrôle poids',
  SEAMING_OPERATION: 'Opération de sertissage',
  SEAMING_CONTROL: 'Contrôle sertissage',
  MARKING_EVENT: 'Marquage',
  STERILIZATION_CYCLE: 'Cycle de stérilisation',
  CCP_CONTROL: 'Contrôle CCP',
  PROCESS_DEVIATION: 'Déviation process',
  DOWNTIME_EVENT: 'Arrêt',
  SUBCONTRACTING_OPERATION: 'Sous-traitance',
  PACKAGING_BATCH: 'Lot d’emballage',
  SHIPMENT: 'Expédition',
  ...
  SUPPLIER_QUALITY_INCIDENT: 'Incident fournisseur',
  RECALL_EVENT: 'Retrait / rappel',
  SOURCE: 'Source',
  AFFECTE: 'Affecté',
  DETECTE_SUR: 'Détecté sur',
  ...
  ISHIKAWA: 'Ishikawa',
  PARETO: 'Pareto',
  ANALYSE_SIMPLE: 'Analyse simple',
  CORRECTIVE: 'Corrective',
  PREVENTIVE: 'Préventive',
  CORRECTIVE_PREVENTIVE: 'Corrective et préventive',
